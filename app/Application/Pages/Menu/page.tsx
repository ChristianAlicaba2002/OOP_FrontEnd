...
const Menu = () => {
  const [scrammble, setScrammble] = useState<[]>([]);

  useEffect(() => {
    const fetchScammble = async () => {
    ...
    <div className="flex bg-white">
      ...
      <div className="flex-grow bg-white">
        ...
        <section id="icecream" className="py-40 px-8">
          ...
          {scrammble.map((item:TProductProps) => {
            return (
              <ProductCard
              key={item.Itemcode}
        ...
        <section id="shakes" className="py-40 px-8">
          ...
          <main className="mx-auto w-[95%] flex flex-wrap justify-center gap-20">
            <ProductCard
              imageUrl="/img/MangoGraham.png"
              title="Classic Mango Graham"
              description="Fresh start with graham"
              sizes="Small, Medium, Large"
              price="₱40.00"
            />
            <ProductCard
              imageUrl="/img/AvocadoOreo.png"
              title="Avocado Oreo"
              description="Smooth avocado with oreos on top."
              sizes="Small, Medium, Large"
              price="₱50.00"
            />
            <ProductCard
              imageUrl="/img/MangoShake.png"
              title="Extra Mango"
              description="Drowned with fresh mangoes."
              sizes="Small, Medium, Large"
              price="₱60.00"
            />
          </main>
        ...
        <section id="drinks" className="py-40 px-8">
          ...
          <main className="mx-auto w-[95%] flex flex-wrap justify-center gap-20">
            <ProductCard
              ...
              title="Assorted Soda Pop"
              description="Guess which soda youll receive today?."
              sizes="Small, Medium, Large"
              price="₱60.00"
            />
          </main>
        ...
        <section id="bites" className="py-24 px-8">
          ...
          <main className="mx-auto w-[95%] flex flex-wrap justify-center gap-20">
            <ProductCard
              imageUrl="/img/OreoGrahamBar.png"
              title="Oreo Graham Bar"
              description="Sweet Fat Oreo Bar!."
              sizes="Small, Medium, Large"
              price="₱60.00"
            />
          </main>
